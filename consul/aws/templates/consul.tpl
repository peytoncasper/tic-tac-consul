...
sudo mv /tmp/aws-server-consul-0.pem /etc/consul.d/aws-server-consul-0.pem
sudo mv /tmp/aws-server-consul-0-key.pem /etc/consul.d/aws-server-consul-0-key.pem
...
cert_file = "/etc/consul.d/aws-server-consul-0.pem"
key_file = "/etc/consul.d/aws-server-consul-0-key.pem"
...
sudo tee -a /etc/consul.d/config/aws-function-defaults.hcl > /dev/null <<EOT
Kind      = "service-defaults"
Name      = "aws-function"
Protocol  = "http"
EOT
...
consul config write /etc/consul.d/config/aws-function-defaults.hcl
consul config write /etc/consul.d/config/aws-function-resolver.hcl